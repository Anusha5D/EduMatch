...
def Recommendations(gender, part_time_job, absence_days, extracurricular_activities,
                    weekly_self_study_hours, math_score, history_score, economics_score,physics_score,
...
def pred():
    if request.method == 'POST':
        ...
        economics_score = int(request.form['economics_score'])
        ...
        recommendations = Recommendations(gender, part_time_job, absence_days, extracurricular_activities,
                                          weekly_self_study_hours, math_score, history_score, economics_score,
